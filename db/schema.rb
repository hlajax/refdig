...
ActiveRecord::Schema.define(version: 2019_12_25_053445) do
  ...
  create_table "apprenants", force: :cascade do |t|
    ...
    t.string "photo"
    t.string "prenoms"
    t.index ["slug"], name: "index_apprenants_on_slug", unique: true
  end
  ...
  create_table "etats", force: :cascade do |t|
    ...
    t.datetime "updated_at", precision: 6, null: false
    t.string "slug"
    t.index ["slug"], name: "index_etats_on_slug", unique: true
  end
